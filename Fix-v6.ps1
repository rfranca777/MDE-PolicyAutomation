<#
.SYNOPSIS
    FIX v6: Match Azure VMs -> Entra ID Devices -> Sync to Groups
.DESCRIPTION
...
Write-Host "  FIX v6 -- MATCH + SYNC" -ForegroundColor White
...
# REPORT
Write-Host "`n================================================================" -ForegroundColor Magenta
Write-Host "  FIX v6 DONE" -ForegroundColor White
...
$sep = "=" * 50
$lf = Join-Path $tempPath ("fix-v6-" + (Get-Date -Format 'yyyyMMdd-HHmmss') + ".log")
